...
remove_files_by_filepath() {
    ...
    whiptail --title "Attention" --msgbox "This function allows user to remove all files under file path. \
It does not search recursively but just files under selected path. If a file has a tag associated with it, it will not be removed." 12 78 >/dev/tty
